...
RSpec.describe BugsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested bug as @bug" do
      bug = Bug.create! valid_attributes
      get :show, params: {id: bug.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested bug as @bug" do
      bug = Bug.create! valid_attributes
      get :edit, params: {id: bug.to_param}, session: valid_session
      expect(assigns(:bug)).to eq(bug)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Bug" do
        expect {
          post :create, params: {bug: valid_attributes}, session: valid_session
      ...
      it "assigns a newly created bug as @bug" do
        ...
        expect(assigns(:bug)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved bug as @bug" do
        post :create, params: {bug: invalid_attributes}, session: valid_session
        expect(assigns(:bug)).to be_a_new(Bug)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bug" do
        bug = Bug.create! valid_attributes
        put :update, params: {id: bug.to_param, bug: new_attributes}, session: valid_session
        bug.reload
      ...
      it "assigns the requested bug as @bug" do
        bug = Bug.create! valid_attributes
        put :update, params: {id: bug.to_param, bug: valid_attributes}, session: valid_session
        expect(assigns(:bug)).to eq(bug)
      end
    ...
    context "with invalid params" do
      it "assigns the bug as @bug" do
        bug = Bug.create! valid_attributes
        put :update, params: {id: bug.to_param, bug: invalid_attributes}, session: valid_session
        expect(assigns(:bug)).to eq(bug)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested bug" do
      bug = Bug.create! valid_attributes
      expect {
        delete :destroy, params: {id: bug.to_param}, session: valid_session
      }.to change(Bug, :count).by(-1)
    end
